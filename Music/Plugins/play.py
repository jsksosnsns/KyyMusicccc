...
✅ Example Using Bots
`/play Main Balak Tu Mata By Jubin Nautiyal`
""",
            )
            return
        what = "Query Given"
...
async def popat(_,CallbackQuery): 
    ...
    try:
        ...
        return await CallbackQuery.message.edit(f"An Error Occurs\n**The possible reasons are**:{e}")       
    if CallbackQuery.from_user.id != int(user_id):
